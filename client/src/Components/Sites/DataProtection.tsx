            ...
            <Grid item xs={10}>
                <Paper sx={{ textAlign: "left", pl: 2 }}>
                    ...
                    <p>
                        ...
                        particularly high priority for the management of the Sober Sailor. The use of the Internet pages
                        of the Sober Sailor is possible without any indication of personal data; however, if a data
                    ...
                    <p>
                        ...
                        and in accordance with the country-specific data protection regulations applicable to the Sober
                        Sailor. By means of this data protection declaration, our enterprise would like to inform the
                    ...
                    <p>
                        As the controller, the Sober Sailor has implemented numerous technical and organizational
                    ...
                    <p>
                        Sober Sailor is distributed under the GNU Affero General Public License V3 and all of its code
                        is acessible on our GitHub page. However user data shall not be stored publicly and is only
                        visible to the developers of this service.
                    </p>

                    <h4>1. Definitions</h4>
                    <p>
                        The data protection declaration of the Sober Sailor is based on the terms used by the European
                    ...
                    <p>Germany</p>
                    <p>Phone: CHANGE</p>
                    <p>Email: info@herobone.de</p>
                    <p>Website: sober-sailor.web.app</p>

                    <h4>3. Cookies</h4>
                    <p>
                        The Internet pages of the Sober Sailor use cookies. Cookies are text files that are stored in a
                    ...
                    <p>
                        Through the use of cookies, the Sober Sailor can provide the users of this website with more
                    ...
                    <p>
                        ...
                        this is taken over by the website, and the cookie is thus stored on the user&apso;s computer
                    ...
                    <p>
                        The website of the Sober Sailor collects a series of general data and information when a data
                    ...
                    <p>
                        When using these general data and information, the Sober Sailor does not draw any conclusions
                        ...
                        in case of a cyber-attack. Therefore, the Sober Sailor analyzes anonymously collected data and
                    ...
                    <p>
                        ...
                        indication of personal data. Which personal data are transmitted to the controller is determined
                        by the respective input mask used for the registration. The personal data entered by the data
                        subject are collected and stored exclusively for internal use by the controller, and for his own
                        purposes. The controller may request transfer to one or more processors (e.g. a parcel service)
                    ...
                    <p>
                        ...
                        offenses. Insofar, the storage of this data is necessary to secure the controller. This data is
                        not passed on to third parties unless there is a statutory obligation to pass on the data, or if
                    ...
                    <ul style={{ listStyle: "none" }}>
                        ...
                        <li>
                            ...
                            <p>
                                ...
                                erasure of personal data stored by the Sober Sailor, he or she may, at any time, contact
                                any employee of the controller. An employee of Sober Sailor shall promptly ensure that
                            ...
                            <p>
                                ...
                                those personal data, as far as processing is not required. An employees of the Sober
                                Sailor will arrange the necessary measures in individual cases.
                            </p>
                        </li>
                        <li>
                            ...
                            <p>
                                ...
                                restriction of the processing of personal data stored by the Sober Sailor, he or she may
                                at any time contact any employee of the controller. The employee of the Sober Sailor
                        ...
                        <li>
                            ...
                            <p>
                                ...
                                contact any employee of the Sober Sailor.
                            </p>
                        </li>
                        <li>
                            ...
                            <p>
                                The Sober Sailor shall no longer process the personal data in the event of the
                            ...
                            <p>
                                If the Sober Sailor processes personal data for direct marketing purposes, the data
                                subject shall have the right to object at any time to processing of personal data
                                concerning him or her for such marketing. This applies to profiling to the extent that
                                it is related to such direct marketing. If the data subject objects to the Sober Sailor
                                to the processing for direct marketing purposes, the Sober Sailor will no longer process
                            ...
                            <p>
                                ...
                                the Sober Sailor for scientific or historical research purposes, or for statistical
                            ...
                            <p>
                                ...
                                the Sober Sailor. In addition, the data subject is free in the context of the use of
                        ...
                        <li>
                            ...
                            <p>
                                ...
                                subject&apos;s explicit consent, the Sober Sailor shall implement suitable measures to
                            ...
                            <p>
                                ...
                                decision-making, he or she may, at any time, contact any employee of the Sober Sailor.
                            </p>
                        </li>
                        <li>
                            ...
                            <p>
                                ...
                                at any time, contact any employee of the Sober Sailor.
                            </p>
                        </li>
                    </ul>
                    <h4>
                    ...
                    <p>
                        ...
                        so-called referrer), which sub-pages were visited, or how often and for what duration a sub-page
                        was viewed. Web analytics are mainly used for the optimization of a website and in order to
                    ...
                    <p>
                        ...
                        the data subject is abridged by Google and anonymised when accessing our websites from a Member
                    ...
                    <p>
                        ...
                        provide online reports, which show the activities on our websites, and to provide other services
                    ...
                    <p>
                        ...
                        will automatically submit data through the Google Analytics component for the purpose of online
                        advertising and the settlement of commissions to Google. During the course of this technical
                        procedure, the enterprise Google gains knowledge of personal information, such as the IP address
                        of the data subject, which serves Google, inter alia, to understand the origin of visitors and
                    ...
                    <p>
                        ...
                        Google Analytics from setting a cookie on the information technology system of the data subject.
                        In addition, cookies already in use by Google Analytics may be deleted at any time via a web
                    ...
                    <h4>9. Data protection provisions about the application and use of Matomo</h4>
                    <p>
                        ...
                        on the behavior of visitors from Internet sites. A web analysis tool collects, inter alia, data
                        on the website from which a data subject came to a website (so-called referrer), which pages of
                        the website were accessed or how often and for which period of time a sub-page was viewed. A web
                        analysis is mainly used for the optimization of a website and the cost-benefit analysis of
                    ...
                    <p>
                        ...
                        controller uses the obtained data and information, inter alia, to evaluate the use of this
                        website in order to compile online reports, which show the activities on our Internet pages.
                    </p>

                    <p>
                        Matomo sets a cookie on the information technology system of the data subject. The definition of
                        cookies is explained above. With the setting of the cookie, an analysis of the use of our
                        website is enabled. With each call-up to one of the individual pages of this website, the
                        Internet browser on the information technology system of the data subject is automatically
                        through the Matomo component prompted to submit data for the purpose of online analysis to our
                        server. During the course of this technical procedure, we obtain knowledge about personal
                        information, such as the IP address of the data subject, which serves to understand the origin
                        of visitors and clicks.
                    </p>

                    <p>
                        The cookie is used to store personal information, such as the access time, the location from
                        which access was made, and the frequency of visits to our website. With each visit of our
                        Internet pages, these personal data, including the IP address of the Internet access used by the
                        data subject, are transferred to our server. These personal data will be stored by us. We do not
                        forward this personal data to third parties.
                    </p>

                    <p>
                        The data subject may, as stated above, prevent the setting of cookies through our website at any
                        time by means of a corresponding adjustment of the web browser used and thus permanently deny
                        the setting of cookies. Such an adjustment to the used Internet browser would also prevent
                        Matomo from setting a cookie on the information technology system of the data subject. In
                        addition, cookies already in use by Matomo may be deleted at any time via a web browser or other
                        software programs.
                    </p>

                    <p>
                        In addition, the data subject has the possibility of objecting to a collection of data relating
                        to a use of this Internet site that are generated by Matomo as well as the processing of these
                        data by Matomo and the chance to preclude any such. For this, the data subject must set a
                        &quot;Do Not Track&quot; option in the browser.
                    </p>

                    <p>
                        With each setting of the opt-out cookie, however, there is the possibility that the websites of
                        the controller are no longer fully usable for the data subject.
                    </p>
                    ...
                    <h4>10. Data protection provisions about the application and use of DoubleClick</h4>
                    <p>
                        On this website, the controller has integrated components of DoubleClick by Google. DoubleClick
                        is a trademark of Google, under which predominantly special online marketing solutions are
                        marketed to advertising agencies and publishers.
                    </p>

                    <p>
                        The operating company of DoubleClick by Google is Google Ireland Limited, Gordon House, Barrow
                        Street, Dublin, D04 E5W5, Ireland.
                    </p>

                    <p>
                        DoubleClick by Google transmits data to the DoubleClick server with each impression, clicks, or
                        other activity. Each of these data transfers triggers a cookie request to the data
                        subject&apos;s browser. If the browser accepts this request, DoubleClick uses a cookie on the
                        information technology system of the data subject. The definition of cookies is explained above.
                        The purpose of the cookie is the optimization and display of advertising. The cookie is used,
                        inter alia, to display and place user-relevant advertising as well as to create or improve
                        reports on advertising campaigns. Furthermore, the cookie serves to avoid multiple display of
                        the same advertisement.
                    </p>

                    <p>
                        DoubleClick uses a cookie ID that is required to execute the technical process. For example, the
                        cookie ID is required to display an advertisement in a browser. DoubleClick may also use the
                        Cookie ID to record which advertisements have already been displayed in a browser in order to
                        avoid duplications. It is also possible for DoubleClick to track conversions through the cookie
                        ID. For instance, conversions are captured, when a user has previously been shown a DoubleClick
                        advertising ad, and he or she subsequently makes a purchase on the advertiser&apos;s website
                    ...
                    <p>
                        ...
                        DoubleClick component to send data for the purpose of online advertising and billing of
                        commissions to Google. During the course of this technical procedure, Google gains knowledge of
                        any data that Google may use to create commission calculations. Google may, inter alia,
                    ...
                    <p>
                        ...
                        time by means of a corresponding adjustment of the web browser used and thus permanently deny
                        the setting of cookies. Such an adjustment to the Internet browser used would also prevent
                        Google from setting a cookie on the information technology system of the data subject. In
                    ...
                    <h4>11. Data Protection and Processing when using our Services</h4>
                    <p>
                        To provide the best experience with our Services, we are hosting our Website as well as our
                        Servers in the Google Cloud. As we are using those services, we can not guarantee for any data
                        Processing done by this Company. We are storing all information about ongoing games in clear
                        text in the according databases, however we are not storing answers longer then they are needed
                        for the game to function. Our servers should regularly clear all game data, but we will not
                        guarantee this. Also the host of a game can choose to store the game data for a longer term
                        access.
                    </p>
                    ...
                    <p>
                        ...
                        <a href="https://abletocontract.com/">digital agreement</a>. The legal texts contained in our
